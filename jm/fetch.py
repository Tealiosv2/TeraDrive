...
print(f"{'Name':<15} {'Case Number':<15} {'Phone':<10} {'Email':<25} {'Drop off':<15} {'Case Status':<15} {'Work Progress':<15}")
for item in response["data"]["boards"][0]["items"]:
    ...
    print(f"{item['name'][:15]:<15} {case_number[:15].ljust(15)} {phone_number[:10].ljust(10)} {email[:25].ljust(25)} {drop_off[:15].ljust(15)} {case_status[:15].ljust(15)} {work_progress[:15].ljust(15)}")
